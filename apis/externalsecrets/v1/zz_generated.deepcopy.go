...
func (in *AlibabaAuth) DeepCopyInto(out *AlibabaAuth) {
	*out = *in
	...
	if in.ServiceAccountAuth != nil {
		...
		*out = new(AlibabaServiceAccountAuth)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AlibabaServiceAccountAuth) DeepCopyInto(out *AlibabaServiceAccountAuth) {
	*out = *in
	if in.Namespace != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AlibabaServiceAccountAuth.
func (in *AlibabaServiceAccountAuth) DeepCopy() *AlibabaServiceAccountAuth {
	if in == nil {
		return nil
	}
	out := new(AlibabaServiceAccountAuth)
